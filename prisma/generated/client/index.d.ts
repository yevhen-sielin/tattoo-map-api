...
export namespace Prisma {
  ...
  */
  ...
  export type UserOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "email" | "googleId" | "name" | "avatar" | "role" | "createdAt", ExtArgs["result"]["user"]>
  ...
  export type ArtistOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"userId" | "city" | "country" | "address" | "nickname" | "description" | "styles" | "instagram" | "avatar" | "createdAt", ExtArgs["result"]["artist"]>
  ...
  export interface ArtistDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * const artistWithUserIdOnly = await prisma.artist.findMany({ select: { userId: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many Artists and only return the `userId`
     * const artistWithUserIdOnly = await prisma.artist.createManyAndReturn({
     *   select: { userId: true },
     *   data: [
     *     // ... provide data here
     *   ]
     ...
     * })
     * 
     * // Update zero or more Artists and only return the `userId`
     * const artistWithUserIdOnly = await prisma.artist.updateManyAndReturn({
     *   select: { userId: true },
     *   where: {
     *     // ... provide filter here
     *   },
  ...
  interface ArtistFieldRefs {
    ...
    readonly address: FieldRef<"Artist", 'String'>
    readonly nickname: FieldRef<"Artist", 'String'>
    readonly description: FieldRef<"Artist", 'String'>
    readonly styles: FieldRef<"Artist", 'String[]'>
  ...
  export type ArtistWhereInput = {
    ...
    country?: StringFilter<"Artist"> | string
    address?: StringFilter<"Artist"> | string
    nickname?: StringFilter<"Artist"> | string
    description?: StringFilter<"Artist"> | string
    styles?: StringNullableListFilter<"Artist">
    instagram?: StringFilter<"Artist"> | string
    avatar?: StringFilter<"Artist"> | string
  ...
  export type ArtistScalarWhereWithAggregatesInput = {
    ...
    country?: StringWithAggregatesFilter<"Artist"> | string
    address?: StringWithAggregatesFilter<"Artist"> | string
    nickname?: StringWithAggregatesFilter<"Artist"> | string
    description?: StringWithAggregatesFilter<"Artist"> | string
    styles?: StringNullableListFilter<"Artist">
    instagram?: StringWithAggregatesFilter<"Artist"> | string
    avatar?: StringWithAggregatesFilter<"Artist"> | string
  ...
  export type ArtistCreateInput = {
    ...
    nickname: string
    description: string
    styles?: ArtistCreatestylesInput | string[]
    instagram: string
    avatar: string
    createdAt?: Date | string
  ...
  export type ArtistUpdateInput = {
    ...
    styles?: ArtistUpdatestylesInput | string[]
  ...
  export type ArtistCreatestylesInput = {
    set: string[]
  }
  ...
  export type ArtistUpdatestylesInput = {
    set?: string[]
    push?: string | string[]
  }
