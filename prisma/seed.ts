    ...
    create: {
      ...
      artist: {
        create: ({
          ...
          email: (u.artist as any).email ?? null,
          website: (u.artist as any).website ?? null,
          tiktok: (u.artist as any).tiktok ?? null,
          facebook: (u.artist as any).facebook ?? null,
          telegram: (u.artist as any).telegram ?? null,
          whatsapp: (u.artist as any).whatsapp ?? null,
          wechat: (u.artist as any).wechat ?? null,
          snapchat: (u.artist as any).snapchat ?? null,
          avatar: u.artist.avatar,
          beginner: Boolean(u.artist.beginner ?? false),
          coverups: Boolean((u.artist as any).coverups ?? false),
